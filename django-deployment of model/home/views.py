...
def about(request):
    ...
    data = data.drop(['Index','Artist','Week of Highest Charting','Weeks Charted','Song Name','Streams','Artist','Song ID','Release Date','Chord'],axis=1)
    ...
    if request.method=='POST':
        ...
        values=scaler.transform([[var1,var2,var3,gener[0],var5,var6,var7,var8,var9,var10,var11,var12,var13]])
        popularity=XGBR.predict(values)[0]
...
def result_page(request):
    ...
    data = data.drop(['Index','Highest Charting Position','Number of Times Charted','Week of Highest Charting','Weeks Charted','Artist','Song Name','Streams','Song ID','Release Date','Chord'],axis=1)
    ...
    if request.method=='POST':
        ...
        # print(var1,var2,var3,var4,var5,var6,var7,var8,var9,var10,var11,var12,var13)
        gener=le_Genre.transform([var4])
        values=scaler.transform([[var3,gener[0],var5,var6,var7,var8,var9,var10,var11,var12,var13]])
        popularity=XGBR.predict(values)[0]
